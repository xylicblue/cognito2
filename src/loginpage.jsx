...
const LoginPage = () => {
  ...
  const loginUrl = `https://${VITE_COGNITO_DOMAIN}/authorize?response_type=code&client_id=${VITE_COGNITO_CLIENT_ID}&redirect_uri=${VITE_COGNITO_REDIRECT_URI}&scope=email+openid+profile`;
